...
def best_name(filename : str) -> str:
    with open(filename, "r") as file:
        ...
        known_names = [name for name in names_dict.keys()]
        beaten_names = [name for defeated_names in names_dict.values() for name in known_names if name in defeated_names]
        unbeaten_names = [name for name in known_names if name not in beaten_names]
