...
def main():
    print(best_name('3/input1.txt')) # Alice
    print(best_name('3/input2.txt')) # Invalid
    print(best_name('3/input3.txt')) # Unknown
    print(best_name('3/input4.txt')) # Alice
    print(best_name('3/input5.txt')) # Elmer
    print(best_name('3/input6.txt')) # Carol
    print(best_name('3/input7.txt')) # Invalid
