...
def matrix_multiply(mat1 : list[list[int]], mat2 : list[list[int]]) -> list[list[int]]:
    ...
    # list comprehension ver 1
    # results = [[0]* mat2_cols for _ in range(mat1_rows)]
    # list comprehension ver 2
    results = [[0 for col in range(mat2_cols)] for row in range(mat1_rows)]
